package com.project.dwine.paging;
...
public class PageInfo {
	...
	public PageInfo(int page, int listCount, int pageLimit, int boardLimit) {
		...
		// 글 개수가 105개이면 총 페이지 수는 자투리 5개까지 한 페이지로 생각해서 11페이지가 필요함
		// 전체 게시글 수 (105) / 한 페이지에 보여질 게시글 수 (10)의 결과를 올림 처리
