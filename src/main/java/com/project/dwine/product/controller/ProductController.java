...
public class ProductController {
	...
	@PostMapping("modify")
	public String modifyProduct(Model model, @RequestParam MultipartFile thumbnail, @RequestParam MultipartFile labelImg, HttpServletRequest request) {
		// 맛그래프, 이미지 제외 정보들
		String kname = request.getParameter("kname");
		String ename = request.getParameter("ename");
		int costPrice = Integer.parseInt(request.getParameter("costPrice"));
		...
		// return "product/detailView/" + productNo;
	}
